...
function MissingEnvVarsError() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-4">
      <div className="max-w-3xl w-full bg-card border border-destructive/50 rounded-lg p-8 space-y-4">
        ...
        <p>Please create or update the <code>.env</code> file in your project's root directory with your Firebase project credentials. You can find these values in the Firebase Console under Project settings &gt; General.</p>
