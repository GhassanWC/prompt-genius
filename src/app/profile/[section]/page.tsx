    ...
    <div className="min-h-screen bg-white dark:bg-[#00171f] text-[#00171f] dark:text-white relative overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <Tabs
          ...
          className="w-full"
          style={{backgroundColor:"transparent", opacity:1, zIndex:1000, position:"relative"}}
        >
          ...
          {error && (
            <Alert variant="destructive" className="mt-6 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800 text-red-800 dark:text-red-300 rounded-2xl">
          ...
          <TabsContent value="details" className="mt-8">
            <Card className="bg-white dark:bg-[#00171f] border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all duration-500 rounded-2xl overflow-hidden">
              ...
              <CardContent className="bg-white dark:bg-[#00171f] p-8">
                <Form {...profileForm}>
                  <form
                    onSubmit={profileForm.handleSubmit(onProfileSubmit)}
                    className="bg-white dark:bg-[#00171f] space-y-8"
                  >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription className="bg-white dark:bg-[#00171f] text-gray-500 dark:text-gray-400 font-medium">
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                {...field}
                                className="pr-12 border-gray-200 dark:border-gray-700 bg-white dark:bg-[#00171f] text-[#00171f] dark:text-white rounded-xl focus:border-[#00171f] dark:focus:border-white focus:ring-2 focus:ring-[#00171f]/20 dark:focus:ring-white/20 transition-all duration-200 font-medium"
                              />
                              <Button
                                type="button"
                                variant="ghost"
                                size="icon"
                                className="absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 text-gray-400 dark:text-gray-500 hover:text-[#00171f] dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-all duration-200"
          ...
          <TabsContent value="subscription" className="mt-8">
            <Card className="bg-white dark:bg-[#00171f] border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all duration-500 rounded-2xl overflow-hidden">
              ...
              <CardContent className="bg-white dark:bg-[#00171f] p-8 space-y-8">
